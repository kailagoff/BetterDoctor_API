export class Doctor{
  ...
  const apiKey = `${process.env.exports.apiKey}`;
  /* eslint-enable */
  $.get(`https://api.betterdoctor.com/2016-03-01/doctors?query=${medicalIssue}&location=45.5230%2C-122.413%2C25&user_location=45.5230%2C-122.413&skip=0&limit=20&user_key=${apiKey}`).then(function(response) {
